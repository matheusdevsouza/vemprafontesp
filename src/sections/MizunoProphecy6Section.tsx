...
export function MizunoProphecy6Section() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true)
        const response = await fetch('/api/products?subcategory_id=3')
        ...
        console.error('Erro ao buscar produtos Prophecy 6:', error)
      } finally {
        setLoading(false)
      }
    }
    ...
    return (
      <section ref={sectionRef} className="py-24 bg-dark-900 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Prophecy 6</h2>
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">
              Tecnologia de amortecimento avançado com design único
            </p>
          </motion.div>
