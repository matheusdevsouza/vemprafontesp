      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        <section className="space-y-8">
          ...
          >
            ...
            <p className="text-gray-300">Em caso de dúvidas sobre os Termos de Uso, entre em contato pelo e-mail <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'contato@vemprafontesp.com.br'}`} className="text-primary-400 hover:underline">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'contato@vemprafontesp.com.br'}</a>.</p>
          </motion.div>
        </section>
      </div>
    </div>
